    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A showcase of the services I offer, including full-stack web
          development, API development with PHP Laravel, responsive single-page
          applications using React, and clean, efficient JavaScript coding
          solutions.
        </p>
      </div>
